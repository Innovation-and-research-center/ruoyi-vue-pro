...
public interface XzssMapper extends BaseMapperX<XzssDO> {
    ...
    default PageResult<XzssDO> selectPage(XzssPageReqVO reqVO) {
        return selectPage(reqVO, new LambdaQueryWrapperX<XzssDO>()
                ...
                .eqIfPresent(XzssDO::getSqr, reqVO.getSqr())
                .eqIfPresent(XzssDO::getBsqr, reqVO.getBsqr())
                .eqIfPresent(XzssDO::getDsr, reqVO.getDsr())
                ...
                .eqIfPresent(XzssDO::getSsNr, reqVO.getSsNr())
                .eqIfPresent(XzssDO::getCbr, reqVO.getCbr())
                .eqIfPresent(XzssDO::getCbRq, reqVO.getCbRq())
                .eqIfPresent(XzssDO::getSfyjgRq, reqVO.getSfyjgRq())
