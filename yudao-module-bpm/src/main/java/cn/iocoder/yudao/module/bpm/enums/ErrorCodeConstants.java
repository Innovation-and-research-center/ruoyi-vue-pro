...
public interface ErrorCodeConstants {
    ...
    ErrorCode RECEIVE_DOC_REGISTER_TASK_NOT_ACTIVE = new ErrorCode(1_009_021_004,"当前流程不在来文登记环节，不能发送");
    ...
    ErrorCode CONFFLOW_REGISTER_TASK_NOT_ACTIVE = new ErrorCode(1_009_022_004, "当前流程不在科室登记环节，不能发送");
    ...
    ErrorCode TASK_CLAIM_FAIL_ASSIGNED = new ErrorCode(1_009_005_022, "认领失败，该任务已被其他人认领");
    ErrorCode TASK_CLAIM_FAIL_NOT_CANDIDATE = new ErrorCode(1_009_005_023, "认领失败，你不是该任务的候选办理人");
